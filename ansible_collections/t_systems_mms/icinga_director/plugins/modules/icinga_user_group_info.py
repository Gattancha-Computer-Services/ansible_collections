...
DOCUMENTATION = """
---
module: icinga_user_group_info
short_description: Query user groups in Icinga2
description:
   - Get a list of user group objects from Icinga2 through the director API.
...
def main():
    ...
    icinga_object = Icinga2APIObject(module=module, path="/usergroups", data=[])
