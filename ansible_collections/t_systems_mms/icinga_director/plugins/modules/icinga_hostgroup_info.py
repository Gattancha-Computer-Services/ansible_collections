...
DOCUMENTATION = """
---
module: icinga_hostgroup_info
short_description: Query hostgroups in Icinga2
description:
   - Get a list of hostgroup objects from Icinga2 through the director API.
...
def main():
    ...
    icinga_object = Icinga2APIObject(module=module, path="/hostgroups", data=[])
