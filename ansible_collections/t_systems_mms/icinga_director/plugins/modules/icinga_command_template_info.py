...
DOCUMENTATION = """
---
module: icinga_command_template_info
short_description: Query command templates in Icinga2
description:
   - Get a list of command template objects from Icinga2 through the director API.
...
def main():
    ...
    icinga_object = Icinga2APIObject(
        module=module, path="/commands/templates", data=[]
    )
