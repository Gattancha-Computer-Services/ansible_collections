...
argument_spec.update(dict(
    ...
    wirelessProfiles=dict(type="list"),
))
...
class NativeSupplicantProfile(object):
    def __init__(self, params, ise):
        ...
        self.new_object = dict(
            ...
            wireless_profiles=params.get("wirelessProfiles"),
        )
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [
            ...
            ("wirelessProfiles", "wireless_profiles"),
        ]
    ...
    def update(self):
        ...
        result = self.ise.exec(
            family="native_supplicant_profile",
            function="update_native_supplicant_profile_by_id",
    ...
    def delete(self):
        ...
        result = self.ise.exec(
            family="native_supplicant_profile",
            function="delete_native_supplicant_profile_by_id",
            params=self.new_object
        ).response
        return result
