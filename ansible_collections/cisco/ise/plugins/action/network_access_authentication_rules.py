...
class NetworkAccessAuthenticationRules(object):
    ...
    def create(self):
        result = self.ise.exec(
            family="network_access_authentication_rules",
            function="create_network_access_authentication_rule",
    ...
    def update(self):
        ...
        result = self.ise.exec(
            family="network_access_authentication_rules",
            function="update_network_access_authentication_rule_by_id",
            params=self.new_object
        ).response
        return result
    ...
    def delete(self):
        ...
        result = self.ise.exec(
            family="network_access_authentication_rules",
            function="delete_network_access_authentication_rule_by_id",
            params=self.new_object
        ).response
        return result
