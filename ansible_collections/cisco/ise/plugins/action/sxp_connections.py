...
argument_spec.update(dict(
    ...
    sxpPeer=dict(type="str"),
    sxpVpn=dict(type="str"),
    sxpNode=dict(type="str"),
    ipAddress=dict(type="str"),
    sxpMode=dict(type="str"),
    sxpVersion=dict(type="str"),
...
class SxpConnections(object):
    def __init__(self, params, ise):
        ...
        self.new_object = dict(
            ...
            sxp_peer=params.get("sxpPeer"),
            sxp_vpn=params.get("sxpVpn"),
            sxp_node=params.get("sxpNode"),
            ip_address=params.get("ipAddress"),
            sxp_mode=params.get("sxpMode"),
            sxp_version=params.get("sxpVersion"),
    ...
    def create(self):
        result = self.ise.exec(
            family="sxp_connections",
            function="create_sxp_connections",
    ...
    def update(self):
        ...
        result = self.ise.exec(
            family="sxp_connections",
            function="update_sxp_connections_by_id",
            params=self.new_object
        ).response
        return result
    ...
    def delete(self):
        ...
        result = self.ise.exec(
            family="sxp_connections",
            function="delete_sxp_connections_by_id",
            params=self.new_object
        ).response
        return result
