...
argument_spec.update(dict(
    ...
    externalIdentityStoreName=dict(type="str"),
    certificateAttributeName=dict(type="str"),
    allowedAsUserName=dict(type="bool"),
    matchMode=dict(type="str"),
    usernameFrom=dict(type="str"),
))
...
class CertificateProfile(object):
    def __init__(self, params, ise):
        ...
        self.new_object = dict(
            ...
            external_identity_store_name=params.get("externalIdentityStoreName"),
            certificate_attribute_name=params.get("certificateAttributeName"),
            allowed_as_user_name=params.get("allowedAsUserName"),
            match_mode=params.get("matchMode"),
            username_from=params.get("usernameFrom"),
        )
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [
            ...
            ("externalIdentityStoreName", "external_identity_store_name"),
            ("certificateAttributeName", "certificate_attribute_name"),
            ("allowedAsUserName", "allowed_as_user_name"),
    ...
    def create(self):
        result = self.ise.exec(
            family="certificate_profile",
            function="create_certificate_profile",
    ...
    def update(self):
        ...
        result = self.ise.exec(
            family="certificate_profile",
            function="update_certificate_profile_by_id",
            params=self.new_object
        ).response
        return result
