...
class EgressMatrixCell(object):
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [
            ...
            ("destinationSgtId", "destination_sgt_id"),
            ("matrixCellStatus", "matrix_cell_status"),
    ...
    def update(self):
        ...
        result = self.ise.exec(
            family="egress_matrix_cell",
            function="update_egress_matrix_cell_by_id",
            params=self.new_object
        ).response
        return result
    ...
    def delete(self):
        ...
        result = self.ise.exec(
            family="egress_matrix_cell",
            function="delete_egress_matrix_cell_by_id",
            params=self.new_object
        ).response
        return result
