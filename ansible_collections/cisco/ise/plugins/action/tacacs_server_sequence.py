...
class TacacsServerSequence(object):
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [
            ...
            ("prefixStrip", "prefix_strip"),
            ("prefixDelimiter", "prefix_delimiter"),
            ("suffixStrip", "suffix_strip"),
    ...
    def create(self):
        result = self.ise.exec(
            family="tacacs_server_sequence",
            function="create_tacacs_server_sequence",
    ...
    def update(self):
        ...
        result = self.ise.exec(
            family="tacacs_server_sequence",
            function="update_tacacs_server_sequence_by_id",
            params=self.new_object
        ).response
        return result
    ...
    def delete(self):
        ...
        result = self.ise.exec(
            family="tacacs_server_sequence",
            function="delete_tacacs_server_sequence_by_id",
            params=self.new_object
        ).response
        return result
