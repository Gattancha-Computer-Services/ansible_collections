...
required_if = [
    ("state", "present", ["id", "name", "settings"], True),
    ("state", "absent", ["id", "name", "settings"], True),
]
required_one_of = []
mutually_exclusive = []
required_together = []
...
class SelfRegisteredPortal(object):
    ...
    def create(self):
        result = self.ise.exec(
            family="self_registered_portal",
            function="create_self_registered_portal",
    ...
    def update(self):
        ...
        result = self.ise.exec(
            family="self_registered_portal",
            function="update_self_registered_portal_by_id",
            params=self.new_object
        ).response
        return result
    ...
    def delete(self):
        ...
        result = self.ise.exec(
            family="self_registered_portal",
            function="delete_self_registered_portal_by_id",
            params=self.new_object
        ).response
        return result
