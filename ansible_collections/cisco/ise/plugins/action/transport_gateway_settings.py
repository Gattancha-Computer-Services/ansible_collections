...
argument_spec.update(dict(
    ...
    enableTransportGateway=dict(type="bool"),
    url=dict(type="str"),
))
...
class TransportGatewaySettings(object):
    def __init__(self, params, ise):
        self.ise = ise
        self.new_object = dict(
            enable_transport_gateway=params.get("enableTransportGateway"),
            url=params.get("url"),
        )
    ...
    def requires_update(self, current_obj):
        ...
        obj_params = [
            ("enableTransportGateway", "enable_transport_gateway"),
            ("url", "url"),
        ]
    ...
    def update(self):
        ...
        result = self.ise.exec(
            family="telemetry",
            function="update_transport_gateway",
