...
class NetworkAccessNetworkCondition(object):
    ...
    def create(self):
        result = self.ise.exec(
            family="network_access_network_conditions",
            function="create_network_access_network_condition",
    ...
    def update(self):
        ...
        result = self.ise.exec(
            family="network_access_network_conditions",
            function="update_network_access_network_condition_by_id",
            params=self.new_object
        ).response
        return result
    ...
    def delete(self):
        ...
        result = self.ise.exec(
            family="network_access_network_conditions",
            function="delete_network_access_network_condition_by_id",
            params=self.new_object
        ).response
        return result
