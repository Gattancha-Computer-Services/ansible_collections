...
def switch_controller_traffic_policy(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete(
            "switch-controller", "traffic-policy", mkey=filtered_data["name"], vdom=vdom
        )
    else:
...
def fortios_switch_controller(data, fos, check_mode):
    ...
    fos.do_member_operation("switch-controller", "traffic-policy")
...
versioned_schema = {
    ...
    "children": {
        ...
        "id": {"revisions": {"v6.2.3": True, "v6.2.0": False}, "type": "integer"},
    },
    "revisions": {
        "v7.4.0": True,
        "v7.2.4": True,
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_traffic_policy"]["options"][
            attribute_name
