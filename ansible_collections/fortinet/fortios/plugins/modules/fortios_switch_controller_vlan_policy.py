...
def switch_controller_vlan_policy(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete(
            "switch-controller", "vlan-policy", mkey=filtered_data["name"], vdom=vdom
        )
    else:
...
def fortios_switch_controller(data, fos, check_mode):
    ...
    fos.do_member_operation("switch-controller", "vlan-policy")
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_vlan_policy"]["options"][
            attribute_name
