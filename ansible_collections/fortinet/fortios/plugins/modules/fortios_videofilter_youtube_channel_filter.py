...
def videofilter_youtube_channel_filter(data, fos):
    vdom = data["vdom"]
    ...
    if state == "present" or state is True:
        ...
        return fos.delete(
            "videofilter", "youtube-channel-filter", mkey=filtered_data["id"], vdom=vdom
        )
    else:
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["videofilter_youtube_channel_filter"]["options"][
            attribute_name
