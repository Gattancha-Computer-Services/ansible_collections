...
def firewall_shaping_policy(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete(
            "firewall", "shaping-policy", mkey=filtered_data["id"], vdom=vdom
        )
    else:
...
def fortios_firewall(data, fos, check_mode):
    ...
    fos.do_member_operation("firewall", "shaping-policy")
    if data["action"] == "move":
...
versioned_schema = {
    ...
    "children": {
        ...
        "traffic_type": {
            ...
            "type": "string",
            "options": [
                {"value": "forwarding", "revisions": {"v7.4.0": True}},
                {"value": "local-in", "revisions": {"v7.4.0": True}},
                {"value": "local-out", "revisions": {"v7.4.0": True}},
            ],
        },
        "srcaddr": {
            "type": "list",
