...
def wireless_controller_ap_status(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete(
            "wireless-controller", "ap-status", mkey=filtered_data["id"], vdom=vdom
        )
    else:
...
def fortios_wireless_controller(data, fos, check_mode):
    ...
    fos.do_member_operation("wireless-controller", "ap-status")
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["wireless_controller_ap_status"]["options"][
            attribute_name
