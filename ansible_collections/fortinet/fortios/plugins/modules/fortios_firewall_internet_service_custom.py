...
def firewall_internet_service_custom(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete(
            "firewall", "internet-service-custom", mkey=filtered_data["name"], vdom=vdom
        )
    else:
...
def fortios_firewall(data, fos, check_mode):
    ...
    fos.do_member_operation("firewall", "internet-service-custom")
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_internet_service_custom"]["options"][
            attribute_name
