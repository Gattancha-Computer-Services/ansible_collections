...
def switch_controller_switch_group(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete(
            "switch-controller", "switch-group", mkey=filtered_data["name"], vdom=vdom
        )
    else:
...
def fortios_switch_controller(data, fos, check_mode):
    ...
    fos.do_member_operation("switch-controller", "switch-group")
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_switch_group"]["options"][
            attribute_name
