...
def fortios_log_fortianalyzer3(data, fos):
    ...
    fos.do_member_operation("log.fortianalyzer3", "override-setting")
    if data["log_fortianalyzer3_override_setting"]:
        resp = log_fortianalyzer3_override_setting(data, fos)
    else:
...
versioned_schema = {
    ...
    "children": {
        ...
        "faz_type": {"revisions": {"v6.2.3": True, "v6.2.0": False}, "type": "integer"},
        "override": {
        ...
        "mgmt_name": {"revisions": {"v6.2.3": True, "v6.2.0": False}, "type": "string"},
        "__change_ip": {
            "revisions": {"v6.2.3": True, "v6.2.0": False},
            "type": "integer",
        },
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["log_fortianalyzer3_override_setting"]["options"][
            attribute_name
