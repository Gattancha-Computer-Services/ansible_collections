...
def wireless_controller_utm_profile(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete(
            "wireless-controller", "utm-profile", mkey=filtered_data["name"], vdom=vdom
        )
    else:
...
def fortios_wireless_controller(data, fos, check_mode):
    ...
    fos.do_member_operation("wireless-controller", "utm-profile")
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["wireless_controller_utm_profile"]["options"][
            attribute_name
