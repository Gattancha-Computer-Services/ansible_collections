...
def switch_controller_snmp_community(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete(
            "switch-controller", "snmp-community", mkey=filtered_data["id"], vdom=vdom
        )
    else:
...
def fortios_switch_controller(data, fos, check_mode):
    ...
    fos.do_member_operation("switch-controller", "snmp-community")
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_snmp_community"]["options"][
            attribute_name
