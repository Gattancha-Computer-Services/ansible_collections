...
def switch_controller_stp_instance(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete(
            "switch-controller", "stp-instance", mkey=filtered_data["id"], vdom=vdom
        )
    else:
...
def fortios_switch_controller(data, fos, check_mode):
    ...
    fos.do_member_operation("switch-controller", "stp-instance")
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_stp_instance"]["options"][
            attribute_name
