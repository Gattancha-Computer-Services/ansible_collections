...
def switch_controller_qos_qos_policy(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete(
            "switch-controller.qos", "qos-policy", mkey=filtered_data["name"], vdom=vdom
        )
    else:
...
def fortios_switch_controller_qos(data, fos, check_mode):
    ...
    fos.do_member_operation("switch-controller.qos", "qos-policy")
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_qos_qos_policy"]["options"][
            attribute_name
