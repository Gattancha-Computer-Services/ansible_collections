...
versioned_schema = {
    ...
    "children": {
        ...
        "netscan_discovery": {
            "revisions": {"v6.0.11": True, "v6.0.0": True},
            "type": "string",
        },
        "netscan_vulnerability": {
            "revisions": {"v6.0.11": True, "v6.0.0": True},
        ...
        "dns": {
            ...
            "type": "string",
            "options": [
                {"value": "enable", "revisions": {"v6.0.11": True, "v6.0.0": True}},
                {"value": "disable", "revisions": {"v6.0.11": True, "v6.0.0": True}},
            ],
        },
        "ssh": {
            "revisions": {"v6.0.11": True, "v6.0.0": True},
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["log_fortianalyzer_cloud_filter"]["options"][
            attribute_name
