...
def switch_controller_qos_dot1p_map(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete(
            "switch-controller.qos", "dot1p-map", mkey=filtered_data["name"], vdom=vdom
        )
    else:
...
def fortios_switch_controller_qos(data, fos, check_mode):
    ...
    fos.do_member_operation("switch-controller.qos", "dot1p-map")
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["switch_controller_qos_dot1p_map"]["options"][
            attribute_name
