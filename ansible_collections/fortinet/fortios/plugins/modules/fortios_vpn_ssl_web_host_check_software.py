...
def vpn_ssl_web_host_check_software(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete(
            "vpn.ssl.web", "host-check-software", mkey=filtered_data["name"], vdom=vdom
        )
    else:
...
def fortios_vpn_ssl_web(data, fos, check_mode):
    ...
    fos.do_member_operation("vpn.ssl.web", "host-check-software")
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["vpn_ssl_web_host_check_software"]["options"][
            attribute_name
