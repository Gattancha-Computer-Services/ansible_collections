...
def firewall_identity_based_route(data, fos, check_mode=False):
    ...
    if state == "present" or state is True:
        ...
        return fos.delete(
            "firewall", "identity-based-route", mkey=filtered_data["name"], vdom=vdom
        )
    else:
...
def fortios_firewall(data, fos, check_mode):
    ...
    fos.do_member_operation("firewall", "identity-based-route")
...
def main():
    ...
    for attribute_name in module_spec["options"]:
        fields["firewall_identity_based_route"]["options"][
            attribute_name
